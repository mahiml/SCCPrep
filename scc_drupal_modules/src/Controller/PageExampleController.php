...
/**
* @file
* Contains \Drupal\scc_page_example\Controller\PageExampleController.
*/

namespace Drupal\scc_page_example\Controller;
...
class PageExampleController {
   ...
   *
   * Our router maps this method to the path 'scc_prep/page_example'.
   */
   ...
   *
   * The router _controller callback, maps the path 'scc_prep/page_example/simple'
   * to this method.
   *
